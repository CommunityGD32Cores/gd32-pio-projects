...
extern uint32_t sys_time_get(void *p);
...
////#define MBEDTLS_PLATFORM_STD_TIME            sys_time_get /**< Default time to use, can be undefined. MBEDTLS_HAVE_TIME must be enabled */
